...
var HBOtherRelay2Device = /** @class */ (function (_super) {
    __extends(HBOtherRelay2Device, _super);
    function HBOtherRelay2Device(log, dAPI, dDevice, storage, config) {
    ...
    HBOtherRelay2Device.prototype.getServices = function () {
    ...
    HBOtherRelay2Device.prototype.getSwitchState = function (callback) {
        var self = this[0];
        var num = this[1];
    ...
    HBOtherRelay2Device.prototype.getDevoloCurrentConsumption = function (callback) {
        var self = this[0];
        var num = this[1];
    ...
    HBOtherRelay2Device.prototype.getDevoloTotalConsumption = function (callback) {
        var self = this[0];
        var num = this[1];
    ...
    HBOtherRelay2Device.prototype.getDevoloTotalConsumptionSince = function (callback) {
        var self = this[0];
        var num = this[1];
    ...
    HBOtherRelay2Device.prototype.setSwitchState = function (value, callback) {
        var self = this[0];
        var num = this[1];
    ...
    return HBOtherRelay2Device;
}(HBDevoloDevice_1.HBDevoloDevice));
exports.HBOtherRelay2Device = HBOtherRelay2Device;
