...
var HBDevoloRelayDevice = (function (_super) {
    __extends(HBDevoloRelayDevice, _super);
    function HBDevoloRelayDevice(log, dAPI, dDevice, storage) {
    ...
    HBDevoloRelayDevice.prototype.getTotalConsumptionSince = function (callback) {
