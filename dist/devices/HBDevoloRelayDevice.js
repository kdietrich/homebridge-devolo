...
var HBDevoloRelayDevice = /** @class */ (function (_super) {
    __extends(HBDevoloRelayDevice, _super);
    function HBDevoloRelayDevice(log, dAPI, dDevice, storage, config) {
    ...
    HBDevoloRelayDevice.prototype.getServices = function () {
    ...
    HBDevoloRelayDevice.prototype.getSwitchState = function (callback) {
    ...
    HBDevoloRelayDevice.prototype.getDevoloCurrentConsumption = function (callback) {
    ...
    HBDevoloRelayDevice.prototype.getDevoloTotalConsumption = function (callback) {
    ...
    HBDevoloRelayDevice.prototype.getDevoloTotalConsumptionSince = function (callback) {
    ...
    HBDevoloRelayDevice.prototype.setSwitchState = function (value, callback) {
    ...
    // START FakeGato (eve app)
    HBDevoloRelayDevice.prototype.getCurrentConsumption = function (callback) {
    ...
    HBDevoloRelayDevice.prototype.getTotalConsumption = function (callback) {
        this.log.debug('%s (%s / %s) > getTotalConsumption will report %s', this.constructor.name, this.dDevice.id, this.dDevice.name, this.totalConsumption);
        return callback(null, this.totalConsumption);
    };
    HBDevoloRelayDevice.prototype.getReset = function (callback) {
    ...
    HBDevoloRelayDevice.prototype.setReset = function (value, callback) {
    ...
    HBDevoloRelayDevice.prototype.onAfterFakeGatoHistoryLoaded = function () {
    ...
    return HBDevoloRelayDevice;
}(HBDevoloDevice_1.HBDevoloDevice));
exports.HBDevoloRelayDevice = HBDevoloRelayDevice;
