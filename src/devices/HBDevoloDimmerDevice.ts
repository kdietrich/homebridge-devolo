...
export class HBDevoloDimmerDevice extends HBDevoloDevice {
    ...
    getBrightness(callback) {
        this.log.debug('%s (%s) > getBrightness', (this.constructor as any).name, this.dDevice.id);
    ...
    setBrightness(value, callback) {
        this.log.debug('%s (%s) > setBrightness to %s', (this.constructor as any).name, this.dDevice.id, value);
